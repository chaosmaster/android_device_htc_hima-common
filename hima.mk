...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/nfc/prebuilts/lib/nfc_nci.msm8994.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/nfc_nci.msm8994.so \
    $(LOCAL_PATH)/configs/nfc/prebuilts/lib64/nfc_nci.msm8994.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/nfc_nci.msm8994.so \
    $(LOCAL_PATH)/configs/nfc/prebuilts/lib/android.hardware.nfc@1.0-impl.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/android.hardware.nfc@1.0-impl.so \
    $(LOCAL_PATH)/configs/nfc/prebuilts/lib64/android.hardware.nfc@1.0-impl.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/android.hardware.nfc@1.0-impl.so
